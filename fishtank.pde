...
/*
// Code that would output fish info to console
for (var fishNum = 0; fishNum < fishArray.length; fishNum++) {
    // describe fish in console
    // fill(0, 0, 0);
    println("Fish ID# " + fishArray[fishNum].id + " is moving " + fishArray[fishNum].direction + ", is located at " + fishArray[fishNum].centerX + "," + fishArray[fishNum].centerY + ", and is " + fishArray[fishNum].bodyLength + " pixels long by " + fishArray[fishNum].bodyHeight + " pixels high.");
    }
*/
